// This package based on "Handle Golang Errors with Stacktrace" article
// https://medium.com/htc-research-engineering-blog/handle-golang-errors-with-stacktrace-1caddf6dab07
